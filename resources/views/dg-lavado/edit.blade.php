...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dgl, ['route' => ['dglavados.update', $dgl->id_DGL], 'method' => 'PUT']) !!}

			@include('dg-lavado.fragment.formedit')
