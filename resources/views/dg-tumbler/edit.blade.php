...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dgt, ['route' => ['dgtumblers.update', $dgt->id_DGT], 'method' => 'PUT']) !!}

			@include('dg-tumbler.fragment.formedit')
