...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($retejido, ['route' => ['reprocesotejidos.update', $retejido->id_ReTej], 'method' => 'PUT']) !!}

			@include('re-tej.fragment.form')
