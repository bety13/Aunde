...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dgpun, ['route' => ['dgpunzonados.update', $dgpun->id_DGP], 'method' => 'PUT']) !!}

			@include('dg-punzo.fragment.formedit')
