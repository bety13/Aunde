...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($repun, ['route' => ['reprocesopunzonados.update', $repun->id_RePunzo], 'method' => 'PUT']) !!}

			@include('re-pun.fragment.form')
