...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($reback, ['route' => ['reprocesobackings.update', $reback->id_ReBack], 'method' => 'PUT']) !!}

			@include('re-back.fragment.form')
