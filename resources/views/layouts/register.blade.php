...
<body>
    ...
    <div id="overlay-1">
        ...
        <div class="content-block" id="contact">
            <div class="overlay-3">
                <header class="block-heading cleafix text-center">
                    <h1 style="color: #d9d9d9">Registro de usuarios</h1>
                ...
                <div class="block-content text-center" style="background-color: ">
                    <div class="container" style="background-color:  ">
                        <div class="row" style="background-color: ">
                                ...
                                <main class="py-4" style="width: 100%; color: black;">
                                    @yield('content')
                                </main>
        ...
        <div style="background-color: rgba(38, 38, 38, 0.84); width: 100%; height: 52px;"></div>
        </div>


    

         <footer id="site-footer" style="height: 65px">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
