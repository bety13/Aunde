...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($bondeo, ['route' => ['telasbondeos.update', $bondeo->id_Bondeo], 'method' => 'PUT']) !!}

			@include('telas-bondeo.fragment.formedit')
