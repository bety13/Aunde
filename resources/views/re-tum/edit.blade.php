...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($retum, ['route' => ['reprocesotumblers.update', $retum->id_ReTum], 'method' => 'PUT']) !!}

			@include('re-tum.fragment.form')
