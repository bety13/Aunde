...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dgbonde, ['route' => ['dgbondeos.update', $dgbonde->id_DGBO], 'method' => 'PUT']) !!}

			@include('dg-bondeo.fragment.formedit')
