...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($pun, ['route' => ['telaspunzonados.update', $pun->id_Punzo], 'method' => 'PUT']) !!}

			@include('telas-punzo.fragment.formedit')
