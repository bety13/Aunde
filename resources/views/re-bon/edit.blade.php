...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($rebon, ['route' => ['reprocesobondeos.update', $rebon->id_ReBondeo], 'method' => 'PUT']) !!}

			@include('re-bon.fragment.form')
