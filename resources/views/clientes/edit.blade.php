@extends('clientes.fragment.interclientes')
@section('content')
...
<div class="section-heading">
	...
	<div style="background-color: #0c2341; height: 2.5px; width: 300px" ></div>
		...
		<h2 style="color: #0c2341;font-size: 25px;font-weight: 600;text-align: center;margin-bottom: 10px;" >
			...
			"Control y Administracion de Clientes"
		</h2>
	<div class="datoss" style="background-color: #e6e6e6">
			<center><br>
			<h4 style="font-size: 19px;">Edita el cliente verificando que todos sus datos sean correctos, posteriormente seran actualizados en el Sistema.</h4><br></center>
	</div>

		@include('clientes.fragment.error')

		{!! Form::model($client, ['route' => ['clientes.update', $client->id_Clien], 'method' => 'PUT']) !!}
