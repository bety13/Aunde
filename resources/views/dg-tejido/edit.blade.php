...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dg, ['route' => ['dgtejidos.update', $dg->id_DG], 'method' => 'PUT']) !!}

			@include('dg-tejido.fragment.formedit')
