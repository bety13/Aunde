...
<h2>Listado de Procesos Area Backing</h2> 
...
{!! Form::text('distanciaW_PBack', null, ['class' => 'form-control'] ) !!}<br><br>

<label style="font-size: 16px; color: black; ">Tiempo W :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
{!! Form::text('tiempoW_PBack', null, ['class' => 'form-control'] ) !!}<br><br>

<label style="font-size: 16px; color: black; ">Velocidad W :</label>&nbsp;
{!! Form::text('velocidadW_PBack', null, ['class' => 'form-control'] ) !!}<br><br>
...
{!! Form::text('distanciaF_PBack', null, ['class' => 'form-control'] ) !!}<br><br>

<label style="font-size: 16px; color: black; ">Tiempo F :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
{!! Form::text('tiempoF_PBack', null, ['class' => 'form-control'] ) !!}<br><br>

<label style="font-size: 16px; color: black; ">Velocidad F :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
{!! Form::text('velocidadF_PBack', null, ['class' => 'form-control'] ) !!}<br><br>
