...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($repelent, ['route' => ['telasrepelentes.update', $repelent->id_Rep], 'method' => 'PUT']) !!}

			@include('telas-repelente.fragment.formedit')
