...
@section('content')
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($retermo, ['route' => ['reprocesotermofijados.update', $retermo->id_ReTermo], 'method' => 'PUT']) !!}

			@include('re-termo.fragment.form')
