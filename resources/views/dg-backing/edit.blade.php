...
<div class="section-heading">
	...
	<div class="datoss" style="background-color: #e6e6e6">
		...
		{!! Form::model($dgback, ['route' => ['dgbackings.update', $dgback->id_DGB], 'method' => 'PUT']) !!}

			@include('dg-backing.fragment.formedit')
